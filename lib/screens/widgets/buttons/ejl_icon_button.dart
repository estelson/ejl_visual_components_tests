...
class EJLIconButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return IconButton(onPressed: onPressed, iconSize: iconSize ?? 32, style: TextButton.styleFrom(iconColor: iconColor ?? Colors.blue), icon: Icon(icon), padding: padding ?? EdgeInsets.all(5));
  }
}
